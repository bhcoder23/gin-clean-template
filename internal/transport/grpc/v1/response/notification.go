...
func NewNotificationResponse(notification *domain.Notification) *v1.NotificationResponse {
	readAt := ""
...
func NewListNotificationsResponse(notifications []domain.Notification, total int) *v1.ListNotificationsResponse {
