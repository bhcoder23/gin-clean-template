...
func (r *V1) createTask() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - createTask")
...
func (r *V1) getTask() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - getTask")
...
func (r *V1) listTasks() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - listTasks")
...
func (r *V1) updateTask() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - updateTask")
...
func (r *V1) transitionTask() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - transitionTask")
...
func (r *V1) deleteTask() server.CallHandler {
	return func(msg *nats.Msg) (any, error) {
		...
		if err != nil {
			errlog.Log(r.l, err, "nats_rpc - V1 - deleteTask")
